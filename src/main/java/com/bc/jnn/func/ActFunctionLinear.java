/*
 * $Id: ActFunctionLinear.java,v 1.6 2006-04-03 10:30:18 olaf Exp $
 *
...
public class ActFunctionLinear implements IActivationFunction {
    ...
    public final void evaluate(JnnUnit unit) {
        unit.setActivation(_slope * (unit.getInput() - _thresh));
    }
}
