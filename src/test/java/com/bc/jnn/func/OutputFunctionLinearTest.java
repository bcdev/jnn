/*
 * $Id: OutputFunctionLinearTest.java,v 1.1 2004-01-30 15:01:11 tom Exp $
 *
...
public class OutputFunctionLinearTest extends TestCase {
    ...
    public OutputFunctionLinearTest(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(OutputFunctionLinearTest.class);
    }
    ...
    protected void setUp() {
        _func = new OutputFunctionLinear();
        assertNotNull(_func);
    }
    ...
    public void testCorrectCalculation() {
        ...
        assertEquals(1.55, unit_1.getOutput(), 1e-6);

        _func.evaluate(unit_2);
        assertEquals(0.38, unit_2.getOutput(), 1e-6);
    }
